...
def valid_data():
    ...
    return {
        ...
        "material": {
            "type": "link_by_uid",
            "id": "5c913611-c304-4254-bad2-4797c952a3b3",
            "scope": "ID",
        },
        "process": {
            "type": "link_by_uid",
            "id": "5c913611-c304-4254-bad2-4797c952a3b4",
            "scope": "ID",
        },
        "spec": {
            "type": "link_by_uid",
            "id": "5c913611-c304-4254-bad2-4797c952a3b5",
            "scope": "ID",
        },
        ...
        "uids": {"id": "09145273-1ff2-4fbd-ba56-404c0408eb49"},
        "tags": [],
        "notes": "Ingredients!",
        "file_links": [],
    }
