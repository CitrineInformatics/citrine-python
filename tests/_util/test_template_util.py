    ...
    faux_gems = [
        ...
        ProcessRun(
            ...
            spec=ProcessSpec(
                ...
                conditions=[
                    Condition(
                        name="cond 1", value=NormalReal(mean=6, std=0.3, units="")
                    ),
                ],
            ),
            parameters=[
                Parameter(
                    name="param 1", value=NormalReal(mean=4.2, std=0.1, units="g")
                ),
        ...
        MaterialSpec(
            ...
            properties=[
                PropertyAndConditions(
                    ...
                    conditions=[
                        Condition(
                            name="cond 2", value=NominalCategorical(category="hi")
                        )
                    ],
                ),
                PropertyAndConditions(
                    property=Property(
                        name="prop 2", value=NominalReal(nominal=33, units="1/lb")
                    ),
                    conditions=[
                        Condition(
                            name="cond 3", value=NominalCategorical(category="citrine")
                        )
                    ],
                ),
            ],
        ...
        MeasurementRun(
            ...
            properties=[
                Property(name="prop 1", value=NominalReal(nominal=4.1, units=""))
            ],
        ),
    ]
    return faux_gems
