...
def test_build_new_execution(collection, generative_design_execution_dict):
    execution: GenerativeDesignExecution = collection.build(
        generative_design_execution_dict
    )
...
def test_trigger_execution(
    collection: GenerativeDesignExecutionCollection,
    generative_design_execution_dict,
    session,
):
    # Given
    ...
    assert session.last_call == FakeCall(
        ...
        json={
            ...
            "structure_exclusions": [
                exclusion.value
                for exclusion in design_execution_input.structure_exclusions
            ],
...
def test_generative_design_execution_results(
    generative_design_execution: GenerativeDesignExecution,
    session,
    example_generation_results,
):
    # Given
