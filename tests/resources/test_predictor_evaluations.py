...
def test_get():
    ...
    expected_call = FakeCall(
        method="GET", path=f"/projects/{pec.project_id}/predictor-evaluations/{id}", params={}
    )
...
def test_trigger_default():
    ...
    pec.trigger_default(
        predictor_id=pred_ref["predictor_id"], predictor_version=pred_ref["predictor_version"]
    )
