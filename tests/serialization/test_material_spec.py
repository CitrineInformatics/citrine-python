                ...
                "conditions": [
                    {
                        ...
                        "template": None,
                        "notes": None,
                        "value": {"type": "nominal_real", "nominal": 300.0, "units": "kelvin"},
                        "file_links": [],
                    }
                ],
            }
...
def test_simple_deserialization(valid_data):
    ...
    assert material_spec.properties[0] == PropertyAndConditions(
        Property("color", origin="specified", value=NominalCategorical("tan")),
        conditions=[
            Condition("temperature", origin="specified", value=NominalReal(300, units="kelvin"))
        ],
    )
