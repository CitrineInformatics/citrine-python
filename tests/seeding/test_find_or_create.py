...
def dataset_collection() -> DatasetCollection:
    datasets = FakeDatasetCollection(project_id=UUID('6b608f78-e341-422c-8076-35adc8828545'),team_id=UUID('6b608f78-e341-422c-8076-35adc8828545'), session=FakeSession())
    for i in range(0, 5):
        num_string = str(i)
