...
The list of tags is optional. The usage scenario is for fine-grained curation. The list of tags should be interpreted as an OR clause, meaning, if a terminal material doesn't contain any of the tags it will be filtered out.
