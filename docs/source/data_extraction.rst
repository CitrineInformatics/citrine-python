...
* Identifiers
  ...
  * :class:`~citrine.gemtables.variables.TerminalMaterialInfo`: for fields defined on the material at the terminal of the Material History, like the name of the material
