...
class Objective(PolymorphicSerializable['Objective']):
    """[ALPHA] A Citrine Objective describes a goal for a score associated with a particular descriptor.
...
class ScalarMaxObjective(Serializable['ScalarMaxObjective'], Objective):
    """[ALPHA] Simple single-response maximization objective with optional bounds on the objective space.
...
class ScalarMinObjective(Serializable['ScalarMinObjective'], Objective):
    """[ALPHA] Simple single-response minimization objective with optional bounds on the objective space.
