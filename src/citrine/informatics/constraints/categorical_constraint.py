...
class AcceptableCategoriesConstraint(
    Serializable["AcceptableCategoriesConstraint"], Constraint
):
    """
    ...
    def __init__(self, *, descriptor_key: str, acceptable_categories: List[str]):
