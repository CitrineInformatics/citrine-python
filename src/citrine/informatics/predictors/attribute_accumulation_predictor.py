...
class AttributeAccumulationPredictor(
    Resource["AttributeAccumulationPredictor"], PredictorNode
):
    ...
    typ = _properties.String(
        "type", default="AttributeAccumulation", deserializable=False
    )
