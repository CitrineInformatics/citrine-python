...
class DesignSpaceSettings(Resource["DesignSpaceSettings"]):
    ...
    exclude_intermediates = properties.Optional(
        properties.Boolean(), "exclude_intermediates"
    )
    ...
    def __init__(
        ...
        *,
        ...
        self.include_ingredient_fraction_constraints = (
            include_ingredient_fraction_constraints
        )
