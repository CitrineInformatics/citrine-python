...
from citrine.informatics.descriptors import Descriptor, IntegerDescriptor, RealDescriptor

__all__ = ["ContinuousDimension", "Dimension", "EnumeratedDimension", "IntegerDimension"]
...
class EnumeratedDimension(Serializable["EnumeratedDimension"], Dimension):
    ...
    def __init__(self, descriptor: Descriptor, *, values: list[str]):
