...
class Session(requests.Session):
    ...
    def put_resource(self, path: str, data: dict, *args, **kwargs) -> dict:
        """PUT data at a particular resource."""
        return self.checked_request('PUT', path, *args, data=data, **kwargs).json()
