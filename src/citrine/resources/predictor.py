...
class PredictorCollection(Collection[Predictor]):
    ...
    def auto_configure(self, training_data: DataSource, pattern="PLAIN") -> Predictor:
        ...
        This method will return an unregistered predictor generated by inspecting the training data and attempting
        to automatically configure the predictor.  The automatic configuration tries to be as inclusive as possible.
