...
class Citrine:
    ...
    def __init__(
        self, api_key: str = None, *, scheme: str = None, host: str = None, port: str | None = None
    ):
        if api_key is None:
        ...
        self.session: Session = Session(refresh_token=api_key, scheme=scheme, host=host, port=port)
